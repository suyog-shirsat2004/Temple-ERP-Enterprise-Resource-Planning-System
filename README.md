...
> 
> 🔗 **Live Backend API:** `https://jean-sunshine-baptist-guided.trycloudflare.com/api` (Cloudflare tunnel — backend must be running locally)
...
```env
VITE_API_URL=https://jean-sunshine-baptist-guided.trycloudflare.com/api
```
...
| Backend API (live tunnel) | https://jean-sunshine-baptist-guided.trycloudflare.com/api |
