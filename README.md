...
> 
> 🔗 **Live Backend API:** `https://modern-wages-meeting-intensity.trycloudflare.com/api` (Cloudflare tunnel — backend must be running locally)
...
```env
VITE_API_URL=https://modern-wages-meeting-intensity.trycloudflare.com/api
```
...
| Backend API (live tunnel) | https://modern-wages-meeting-intensity.trycloudflare.com/api |
